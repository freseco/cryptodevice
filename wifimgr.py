...
#Archivo donde se guardaran los datos de aunteticación de la wifi.
NETWORK_PROFILES = 'wifi.dat'

wlan_ap  = network.WLAN(network.AP_IF)  #punto de acceso
wlan_sta = network.WLAN(network.STA_IF) #cliente wifi
